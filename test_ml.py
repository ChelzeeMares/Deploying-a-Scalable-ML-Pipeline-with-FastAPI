...
def test_three():
    ...
    unittest.TestCase().assertAlmostEqual(precision, expected_precision, places=8)
    unittest.TestCase().assertAlmostEqual(recall, expected_recall, places=8)
    unittest.TestCase().assertAlmostEqual(f1, expected_f1, places=8)
pass
