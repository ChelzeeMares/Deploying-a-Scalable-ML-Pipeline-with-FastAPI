...
def test_three():
    ...
    unittest.TestCase().assertAlmostEqual(precision, expected_precision)
    unittest.TestCase().assertAlmostEqual(recall, expected_recall)
    unittest.TestCase().assertAlmostEqual(f1, expected_f1)
pass
